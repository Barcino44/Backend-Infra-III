...
public class DataLoader {
    ...
    public CommandLineRunner loadData() {
        return args -> {
            ...
            productRepository.save(new Product(2L,
                    "PlayStation 5",
                    599.99,
            ...
            productRepository.save(new Product(4L,
                    "Monitor LG",
                    249.99,
            ...
            productRepository.save(new Product(5L,
                    "Teclado Mecánico",
                    89.99,
            ...
            productRepository.save(new Product(6L,
                    "Mouse Inalámbrico",
                    39.99,
            ...
            productRepository.save(new Product(7L,
                    "Tableta Gráfica",
                    199.99,
            ...
            productRepository.save(new Product(8L,
                    "Disco Duro Externo",
                    119.99,
            ...
            productRepository.save(new Product(9L,
                    "Impresora EPSON",
                    299.99,
